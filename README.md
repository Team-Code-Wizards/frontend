...
Константа называется заглавными буквами в SNAKE_CASE. Если группа констант хранится в отдельном файле, они сначала импортируются в главный файл _index.tsx_, а уже оттуда в другие файлы проекта.
