			...
			<div className={styles['container__content']}>
				<div className={styles['container__content_block']}>
					...
					<p>
						...
						данных команды Code Wizards (далее – Оператор).
					</p>
					<p>
				...
				<div className={styles['container__content_block']}>
					...
					<p>
						...
						в сети интернет по сетевому адресу https://code-wizards.team/
					</p>
					<p>
					...
					<p>9. Пользователь – любой посетитель веб-сайта code-wizards.team</p>
					<p>
				...
				<div className={styles['container__content_block']}>
					...
					<p>
						...
						к Оператору с помощью электронной почты email@code-wizards.team
					</p>
					<p>
					...
					<p>
						...
						Интернет по адресу code-wizards.team/policy.
					</p>
				</div>
			</div>
		</main>
