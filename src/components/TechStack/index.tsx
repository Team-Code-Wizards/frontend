...
export default function TechStack() {
	return (
		<section className={style['tech-stack']}>
			<div className={style['tech-stack__container']}>
				<div className={style['tech-stack__head']}>
					...
					<div className={style['tech-stack__short-description']}>
						...
						<p>
							...
							страсть, но и прибегаем к передовым технологиям. наш блестящий
							стек технологий обеспечивает несравненное качество и
